...
var tools = require( './extra/tools' );

describe( 'ElementBox', function ( ) {

    it( 'should give full width to width-less static elements', function ( ) {

        var tree = tools.createTree( { }, [
            'screen', tools.createScreen, [
                [ 'main', { } ] ] ] );
    ...
    it( 'should adapt the height of height-less elements to their content heights', function ( ) {
    ...
    it( 'should use the width/height specified in the properties with static elements', function ( ) {
    ...
    it( 'should accept relative sizes when dealing with static elements', function ( ) {
    ...
    it( 'should ignore positioning attributes when dealing with static and relative elements', function ( ) {
    ...
    it( 'should accept top/right/bottom/left positioning when dealing with absolute and fixed elements', function ( ) {
    ...
    it( 'should automatically deduce its width/height when dealing with absolute and fixed elements', function ( ) {
    ...
    it( 'should put static elements one bottom of the other', function ( ) {
    ...
    it( 'should compute top/right/bottom/left relative to the content box of its first absolute ascendant', function ( ) {
